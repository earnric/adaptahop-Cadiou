...
!!$        call do_colorize(icolor_select,igroup,igr,rhot)
        ncall=0                                               !YDdebug
        call do_colorize(icolor_select,igroup,igr,rhot,ncall) !YDdebug
...
end subroutine treat_particle

!=======================================================================
subroutine do_colorize_norec(icolor_select,igroup,igr,rhot,ncall)
!=======================================================================
...
! We connect this group to its neighbourg
        ...
        if (color(igr2).eq.0) then
           call do_colorize(icolor_select,igroup2,igr2,rhot,ncall)
...
end subroutine do_colorize_norec


!=======================================================================
!!$recursive subroutine do_colorize(icolor_select,igroup,igr,rhot)
recursive subroutine do_colorize(icolor_select,igroup,igr,rhot,ncall) !YDdebug
!=======================================================================
...
!!$           call do_colorize(icolor_select,igroup2,igr2,rhot)
           call do_colorize(icolor_select,igroup2,igr2,rhot,ncall) !YDdebug
        elseif (color(igr2).ne.icolor_select) then
           write(errunit,*) 'ERROR in do_colorize : color(igr2) <> icolor_select'
           write(errunit,*) 'The connections are not symmetric.'
           STOP
